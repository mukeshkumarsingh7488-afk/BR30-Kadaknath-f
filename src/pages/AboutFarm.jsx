        ...
        <section className="about-farm-products section">
          <div className="container">
            ...
            <div className="about-farm-offer-grid">
              <div className="about-farm-offer-item">
                <span>01</span>
                <h3>Kadaknath Eggs</h3>
                <p>Farm-raised eggs carefully handled and packed for customers.</p>
              </div>

              <div className="about-farm-offer-item">
                <span>02</span>
                <h3>Kadaknath Chicken</h3>
                <p>Naturally raised Kadaknath chicken with careful farm handling.</p>
              </div>

              <div className="about-farm-offer-item">
                <span>03</span>
                <h3>Kadaknath Chicks</h3>
                <p>Chicks for customers looking to start or expand their farm.</p>
              </div>

              <div className="about-farm-offer-item">
                <span>04</span>
                <h3>Breeding & Hatching</h3>
                <p>Selected breeding birds and hatching eggs based on available farm stock.</p>
              </div>
            </div>
          </div>
        </section>
